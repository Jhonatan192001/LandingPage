    ...
    return (
        <section id="Home" className="min-h-[90vh] grid grid-cols-1 xl:grid-cols-8">
            ...
            <div className="md:col-span-3 flex items-center justify-center relative">
                ...
                {/* Circulos */}
                <div className="absolute top-1/2 -translate-y-1/2 left-1/2 -translate-x-1/2 w-[280px] h-[280px] md:h-[380px] bg-white border-[10px] border-primary rounded-full -z-10"></div>
                {/* Logos */}
                <img
                src="figma.png"
                className="w-10 h-10 md:w-20 md:h-20 object-cover rounded-full border-1-8 border-gray-600 absolute top-[12%] right-[20%] xl:right-[10%]"
                />
                <img
                src="adobe.png"
                className="w-10 h-10 md:w-20 md:h-20 object-cover rounded-full border-1-8 border-gray-600 absolute top-[10%] xl:top-[2%] left-[20%] xl:left-[10%]"
                />
                <img 
                src="sketch.png" 
                alt="" 
